...
## Where Spaces Appear on Your Public Site

| Public URL | What Visitors See |
|---|---|
| `yoursite.com/community` | All public spaces listed with name, description, member count, and thread count. |
| `yoursite.com/community/{slug}` | The individual space page showing threads, replies, and discussion activity. |

- Only **public** spaces appear in the community listing. **Private** and **paid** spaces are hidden from the public page.
- The `{slug}` is set when you create the space in admin (auto-generated from the name, or customized manually).
