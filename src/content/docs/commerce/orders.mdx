...
- If the order contains course products, the customer is automatically enrolled in the linked courses. Once enrolled, the customer can access their course on the public site at `yoursite.com/courses/{slug}`.
